...
8. **الحفظ المحلي الدائم (Local Persistence via Hive)**:
   * حفظ ثواني المشاهدة وحالات الاكتمال وتاريخ آخر مشاهدة والملاحظات محلياً عبر `Hive`.
...
2. **نظام تدوين الملاحظات المحلي (Lesson Notes CRUD)**:
   * إمكانية كتابة ملاحظات مخصصة مرتبطة بزمن الفيديو مع إمكانية القفز للثانية المحددة بنقرة وحذف الملاحظات.
3. **زر التبديل السريع للغة (Arabic ⇄ English Switcher)**:
   * زر في الـ AppBar يبدل اتجاه النص ومحتوى الواجهات بسلاسة.
